...
```
    ...
    ## Achieved convergence tolerance: 6.932e-06
...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.18     0.31 1.00      938      854
    ## gamma_Intercept      0.32      0.03     0.27     0.39 1.00     1088      951
    ## lambda_Intercept     1.24      0.30     0.76     1.97 1.00     1117     1189
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1650     1640
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.15     0.27 1.01      669     1129
    ## gamma_Intercept      0.36      0.03     0.31     0.42 1.00      798     1475
    ## lambda_Intercept     1.03      0.20     0.71     1.49 1.00      776     1661
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     1958     1744
    ## phi_Intercept       -0.84      0.11    -1.07    -0.62 1.00     2436     1928
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2470     1871
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
